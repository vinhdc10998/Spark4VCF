error id: file://<WORKSPACE>/src/main/scala/extprg/annovar/ANNOVAR.scala:
file://<WORKSPACE>/src/main/scala/extprg/annovar/ANNOVAR.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -utils/CustomOperators.prjTmpDir.getAbsolutePath.
	 -utils/CustomOperators.prjTmpDir.getAbsolutePath#
	 -utils/CustomOperators.prjTmpDir.getAbsolutePath().
	 -prjTmpDir/getAbsolutePath.
	 -prjTmpDir/getAbsolutePath#
	 -prjTmpDir/getAbsolutePath().
	 -scala/Predef.prjTmpDir.getAbsolutePath.
	 -scala/Predef.prjTmpDir.getAbsolutePath#
	 -scala/Predef.prjTmpDir.getAbsolutePath().
offset: 6633
uri: file://<WORKSPACE>/src/main/scala/extprg/annovar/ANNOVAR.scala
text:
```scala
