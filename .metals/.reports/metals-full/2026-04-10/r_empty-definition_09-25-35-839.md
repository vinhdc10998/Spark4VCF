error id: file://<WORKSPACE>/src/main/scala/VASparkApplication.scala:annotateByVep.
file://<WORKSPACE>/src/main/scala/VASparkApplication.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -extprg/vep/VEP.annotateByVep.
	 -extprg/vep/VEP.annotateByVep#
	 -extprg/vep/VEP.annotateByVep().
	 -extprg/annovar/ANNOVAR.annotateByVep.
	 -extprg/annovar/ANNOVAR.annotateByVep#
	 -extprg/annovar/ANNOVAR.annotateByVep().
	 -extprg/snpeff/SNPEFF.annotateByVep.
	 -extprg/snpeff/SNPEFF.annotateByVep#
	 -extprg/snpeff/SNPEFF.annotateByVep().
	 -extprg/pypgx/PYPGX.annotateByVep.
	 -extprg/pypgx/PYPGX.annotateByVep#
	 -extprg/pypgx/PYPGX.annotateByVep().
	 -extprg/gatk/GATK.annotateByVep.
	 -extprg/gatk/GATK.annotateByVep#
	 -extprg/gatk/GATK.annotateByVep().
	 -extprg/deepvariant/DeepVariant.annotateByVep.
	 -extprg/deepvariant/DeepVariant.annotateByVep#
	 -extprg/deepvariant/DeepVariant.annotateByVep().
	 -annotateByVep.
	 -annotateByVep#
	 -annotateByVep().
	 -scala/Predef.annotateByVep.
	 -scala/Predef.annotateByVep#
	 -scala/Predef.annotateByVep().
offset: 5250
  ...
  OParser.parse(mParser, args, Config()) match {
    case Some(config) =>
      ...
      config.annotationTool match {
        case "vep"         => annotat@@eByVep(sc, config.toolArgs, config.toolDir)
