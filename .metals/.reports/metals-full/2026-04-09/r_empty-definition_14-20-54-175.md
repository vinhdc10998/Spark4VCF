error id: file://<WORKSPACE>/src/main/scala/extprg/vep/VEP.scala:filterDivisor.
file://<WORKSPACE>/src/main/scala/extprg/vep/VEP.scala
empty definition using pc, found symbol in pc: filterDivisor.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -java/io/dataRDD/filterDivisor.
	 -java/io/dataRDD/filterDivisor#
	 -java/io/dataRDD/filterDivisor().
	 -dataRDD/filterDivisor.
	 -dataRDD/filterDivisor#
	 -dataRDD/filterDivisor().
	 -scala/Predef.dataRDD.filterDivisor.
	 -scala/Predef.dataRDD.filterDivisor#
	 -scala/Predef.dataRDD.filterDivisor().
offset: 1050
...
def annotateByVep(
    ...
    val (headerRDD, variantsRDD) = dataRDD.fi@@lterDivisor(line => line.startsWith("#"))
