error id: file://<WORKSPACE>/src/main/scala/extprg/pypgx/pypgx.scala:SparkContext#
...
object PYPGX {
  ...
  def annotateByPypgx(sc: S@@parkContext, pyPGXArgs: String, execDir: String): Unit = {
    ...
    val finalCmd = s"xargs -I {} pypgx $pyPGXArgs --samples {}"
