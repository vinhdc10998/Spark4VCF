error id: file://<WORKSPACE>/src/main/scala/extprg/pypgx/pypgx.scala:scala/Option#getOrElse().
file://<WORKSPACE>/src/main/scala/extprg/pypgx/pypgx.scala
empty definition using pc, found symbol in pc: scala/Option#getOrElse().
...
object PYPGX {
  ...
  def annotateByPypgx(sc: SparkContext, pyPGXArgs: String, execDir: String): Unit = {
    ...
    val localOutputDir = parsePositionalOutput(pyPGXArgs).getOrEl@@se {
